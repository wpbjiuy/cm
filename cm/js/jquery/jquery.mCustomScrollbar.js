    ...
    function(e) {
                    ...
                    function() {
                        var o = function a() {
                            i = setTimeout(function() {
                                e.event.special.mousewheel ? (clearTimeout(i), R.call(t[0])) : a()
                            },
                            100)
                        };
                        o()
        ...
        z = function() {
            ...
            function() {
                ...
                i = 0;
                o.is(n.advanced.autoScrollOnFocus) && (N(t), clearTimeout(t[0]._focusTimeout), t[0]._focusTimer = a ? (i + 17) * a: 0, t[0]._focusTimeout = setTimeout(function() {
                    var e = [tt(o)[0], tt(o)[1]],
                    a = [r[0].offsetTop, r[0].offsetLeft],
                    s = [a[0] + e[0] >= 0 && a[0] + e[0] < l.height() - o.outerHeight(!1), a[1] + e[1] >= 0 && a[0] + e[1] < l.width() - o.outerWidth(!1)],
                    c = "yx" !== n.axis || s[0] || s[1] ? "all": "none";
                    "x" === n.axis || s[0] || V(t, e[0].toString(), {
                        dir: "y",
                        scrollEasing: "mcsEaseInOut",
                        overwrite: c,
                        dur: i
                    }),
                    "y" === n.axis || s[1] || V(t, e[1].toString(), {
                        dir: "x",
                        scrollEasing: "mcsEaseInOut",
                        overwrite: c,
                        dur: i
        ...
        F = function(t, o, n, i, r) {
            ...
            switch (o) {
            case "on":
                if (f.dir = [n === d[16] || n === d[15] || 39 === n || 37 === n ? "x": "y", n === d[13] || n === d[15] || 38 === n || 37 === n ? -1 : 1], N(t), et(n) && "stepped" === f.type) return;
                l(m);
                break;
            case "off":
                s(),
        ...
        X = function(t, o) {
            if (null != t && "undefined" != typeof t) {
                ...
                case "number":
                    ...
                    return e(t).length ? "x" === o ? tt(e(t))[1] : tt(e(t))[0] : (l.css(h, t), void u.update.call(null, n[0]))
                }
            }
        },
        q = function(t) {
        ...
        V = function(t, o, n) {
            ...
            if (s.trigger = n.trigger, (0 !== m.scrollTop() || 0 !== m.scrollLeft()) && (e(".mCSB_" + s.idx + "_scrollbar").css("visibility", "visible"), m.scrollTop(0).scrollLeft(0)), "_resetY" !== o || s.contentReset.y || (i("onOverflowYNone") && c.callbacks.onOverflowYNone.call(t[0]), s.contentReset.y = 1), "_resetX" !== o || s.contentReset.x || (i("onOverflowXNone") && c.callbacks.onOverflowXNone.call(t[0]), s.contentReset.x = 1), "_resetY" !== o && "_resetX" !== o) {
                ...
                (s.tweenRunning || !(0 === w && b[0] >= 0 || w === S[0] && b[0] <= S[0])) && Q(h[0], _, Math.round(b[0]), u[0], n.scrollEasing, n.overwrite, {
                    ...
                    onUpdate: function() {
                        /*jiuy*/
                        if(window.zwheel) window.zwheel(-h[0].offsetTop);
        ...
        e(window).load(function() {
            ...
            e.extend(e.expr[":"], {
                ...
                function(t) {
                    ...
                    a[0] + tt(n)[0] >= 0 && a[0] + tt(n)[0] < o.height() - n.outerHeight(!1) && a[1] + tt(n)[1] >= 0 && a[1] + tt(n)[1] < o.width() - n.outerWidth(!1)
                },
